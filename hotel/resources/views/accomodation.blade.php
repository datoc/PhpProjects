...
<html lang="en-US">
    <head>
        <title>Hotel&nbsp;-&nbsp;Accomodation</title>
        <meta charset="utf-8">
    ...
    <body>
                ...
                <div class="container">
                    <div class="navbar navbar-default">
                        <div class="navbar-header">
                            <a href="" class="navbar-brand" style="font-size: 30px;color:#fff">Hotel</a>
        ...
        <div class="container">
            <br>
            <h1 class="text-center" style="font-size: 40px;"><strong>Accomodation</strong></h1>
            <br>
            <center><div class="line text-center"></div></center>
            <br>
                @foreach($rooms as $room)
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 blocks" style="width:380px">
                        <img src="img/{{$rooms->image}}" class="img-responsive">
                        <br>
                        <p>{{$rooms->description}}</p>
                        <strong>{{$rooms->date}}</strong>
                        <br>
                        <a href="details/{{$rooms->id}}"><button type="button" class="bt">Read more</button></a>
                    </div>
                @endforeach
            <br>
